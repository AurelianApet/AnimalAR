...
public class MarkerTrackableEventHandler : MonoBehaviour, ITrackableEventHandler
{
    #region PUBLIC_MEMBER_VARIABLES

    public GameObject mContent;
    public scene_manager mSceneManager;
    ...
    protected virtual void OnTrackingFound()
    {
        ...
        mSceneManager.ShowDinoContent(this.gameObject, mContent, animalID);
        Global.curMarkerId = animalID;
        if (animalID == 11 || animalID == 9 || animalID == 16 || animalID == 3)
        {
