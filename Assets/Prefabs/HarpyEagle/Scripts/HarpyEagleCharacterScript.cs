...
/*
             Debug.Log("isflying");
			if(forwardAcceleration<0f){
				harpyEagleRigid.velocity=transform.up*upDown*20f+transform.forward*forwardSpeed;	
			}else if(forwardAcceleration>0f){
                harpyEagleRigid.velocity=transform.up*(upDown*20f+(forwardSpeed-meanForwardSpeed))+transform.forward*forwardSpeed*100f;
            }
            else
            {
                harpyEagleRigid.velocity=transform.up*(upDown*20f+(forwardSpeed-maxForwardSpeed))+transform.forward*forwardSpeed;
			}
